    ...
    for (let i = currentGroupStart; i < currentGroupEnd; i++) {
      buttons.push(
        <Button
          ...
          mode="icon"
          variant="ghost"
          className={cn(btnBaseClasses, 'text-mutedForeground', {
    ...
    >
      <div className="flex flex-wrap items-center space-x-2.5 pb-2.5 sm:pb-0 order-2 sm:order-1">
        {isLoading ? (
          ...
          <>
            <div className="text-sm text-mutedForeground">Rows per page</div>
            <Select
              value={`${pageSize}`}
      ...
      <div className="flex flex-col sm:flex-row justify-center sm:justify-end items-center gap-2.5 pt-2.5 sm:pt-0 order-1 sm:order-2">
        {isLoading ? (
          ...
          <>
            <div className="text-sm text-mutedForeground text-nowrap order-2 sm:order-1">{paginationInfo}</div>
            {pageCount > 1 && (
