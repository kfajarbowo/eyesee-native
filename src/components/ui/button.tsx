  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-secondary text-secondaryForeground hover:bg-secondary/90 data-[state=open]:bg-secondary/90',
        outline:
        ...
        dim: 'text-mutedForeground hover:text-foreground data-[state=open]:text-foreground',
        foreground: '',
        inverse: '',
      },
      appearance: {
    ...
    compoundVariants: [
      ...
      // Input mode
      {
        ...
        placeholder: true,
        variant: 'outline',
        className: 'font-normal text-mutedForeground',
      },
      {
        mode: 'input',
        variant: 'outline',
