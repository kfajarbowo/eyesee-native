...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      {...props}
    >
      <span className="absolute start-2 flex h-3.5 w-3.5 items-center text-mutedForeground justify-center">
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      className={cn('px-2 py-1.5 text-xs text-mutedForeground font-medium', inset && 'ps-8', className)}
      {...props}
    />
  );
}
